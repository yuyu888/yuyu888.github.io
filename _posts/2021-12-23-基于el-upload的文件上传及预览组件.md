...
<template>
  <div>
    ...
    <el-image
      ...
      :key="i"
      :src="item.url" alt="">
      <div slot="error" class="image-slot" @click="handlePictureCardPreview(item)">
        <img src="https://pic2.zhimg.com/80/v2-0cc642bd1a977891d2c3407ff2f55619_1440w.jpg" width="145" height="145"></img>
      </div>
    </el-image>

    <el-dialog :visible.sync="dialogVisible">
      <iframe :src="dialogImageUrl" v-if="showIframe" frameborder="0" style="width: 100%; height: 600px;"></iframe>
